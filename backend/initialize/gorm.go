...
func initGorm() {
	...
	if err := db.AutoMigrate(models.User{}, models.ProductSeries{}, models.Product{}, models.JournalismSeries{}, models.Journalism{}, models.JournalismSeries{}, models.Journalism{}, models.SoftwareCategory{}, models.Software{}); err != nil {
