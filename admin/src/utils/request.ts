...
class Request {
  ...
  public get<T = any>(url: string, config?: AxiosRequestConfig): Promise<RequestResponse<T>> {
  ...
  public delete<T = any>(url: string, config?: AxiosRequestConfig): Promise<RequestResponse<T>> {
